...
internal val logger: SkipLogger = SkipLogger(subsystem = "zeron.mobile", category = "ZeronMobile")

private typealias AppRootView = ZeronMobileRootView
private typealias AppDelegate = ZeronMobileAppDelegate
